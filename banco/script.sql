...
CREATE TABLE IF NOT EXISTS `ficharpg`.`Personagem` (
  ...
  `fk_id_atributos` INT NOT NULL,
  `fk_id_personalidade` INT NOT NULL,
  `fk_id_equipamentos` INT NOT NULL,
  `fk_id_habilidades` INT NOT NULL,
  `fk_id_caracteristicas` INT NOT NULL,
  `fk_id_aparencia` INT NOT NULL,
  `fk_id_historia` INT NOT NULL,
